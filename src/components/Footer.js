  ...
  return (
    <div>
      <footer class="footer mt-auto  bg-light">      
        <div class="container1" Style="text-align: center font-size: large; background-color: azure; height:50px" style={{color:"black",marginTop:"-5px",color:"darkgreen", border:"2px",font:"large"}}>
